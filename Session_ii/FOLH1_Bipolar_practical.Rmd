...
➡️ Format data for colocalisation analysis
...
## Advanced sensitivity analyses (highly optional for beginners)

---

### Sensitivity analysis on a range of prior probabilities

In the 'coloc' R package, there is an embedded function that can help you test how your prior settings might influence your results.

Here in this demo, we used the default pior probability setting at 1e-5 (most common prior). Run the code below and you'll see how the results will vary based on the chosen prior probability.

```{r,waning=F,message=F,echo=T}
sensitivity(res.coloc,"H4 > 0.7")
```
